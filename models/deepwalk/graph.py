...
def build_deepwalk_corpus(G, num_paths, path_length, alpha=0,
                          ...
                          node_start_condition=lambda x: True):
    walks = []

    nodes = [n for n in G.nodes() if node_start_condition(n)]
    ...
    for cnt in range(num_paths):
        ...
        if cnt % 1000 == 0:
            print("Walked ", cnt * concept_node_count,
                " of ", num_paths * concept_node_count, " times:",
                100.0 * cnt / num_paths, " percent done")
    print("Done walking.")
    return walks
